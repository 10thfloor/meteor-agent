export type Phase = 'idle' | 'streaming' | 'calling' | 'awaiting' | 'compacting' | 'retrying' | 'stopped' | 'error';
/** Phases in which a turn is running. ONE definition — two lists answering
 *  the same question is how they drift. */
export declare const ACTIVE_PHASES: Phase[];
...
export declare const DECIDED_PHASES: Phase[];
 ...
 *  refused. */
export declare const MAX_PARTICIPANTS = 16;
...
export declare const MEMORY_MAX_DEFAULT = 200;
export declare const MEMORY_MAX_APP_DEFAULT = 500;
...
export type MemorySearchFn = (query: string, ctx: {
    userId: string | null;
    agent: string;
    scopes: MemoryScope[];
    limit: number;
