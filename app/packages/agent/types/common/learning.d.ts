...
export type AgentPracticeStatus = 'candidate' | 'validated' | 'hardened' | 'retired' | 'rejected';
...
export type AgentLearningEventKind = 'identity-created' | 'identity-updated' | 'constitution-revised' | 'identity-lifecycle-changed' | 'experience-recorded' | 'experience-retracted' | 'practice-proposed' | 'practice-transitioned' | 'learning-reviewed' | 'memory-frame-frozen' | 'provider-requested';
...
export declare const LEARNING_TEXT_MAX = 2000;
export declare const LEARNING_CONTEXT_MAX = 256;
export declare const EXPERIENCE_RECALL_DEFAULT = 4;
export declare const EXPERIENCE_RECALL_MAX = 20;
export declare const EXPERIENCE_AUTOMATIC_REVIEW_MAX = 100;
export declare const PRACTICE_EVIDENCE_MAX = 50;
export declare const PRACTICE_CANDIDATE_MAX = 25;
export declare const PRACTICE_AUTOMATIC_REVIEW_MAX = 25;
export declare const PRACTICE_FRAME_DEFAULT = 32;
export declare const PRACTICE_FRAME_MAX = 50;
export declare const IDENTITY_FLEXIBILITY_DEFAULT = 3;
