Package.describe({
  name: '10thfloor:agent-channel-slack',
  version: '0.2.0',
  summary: 'Slack channel for 10thfloor:agent — one lens, one transport, one profile',
...
Package.onTest((api) => {
  ...
  api.use(['10thfloor:agent', '10thfloor:agent-channel-slack'], 'server');
